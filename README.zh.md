...
```sh
npx github:im-Captain/dsh-session-rescue export 37374e34        # 抢救对话全文为 Markdown
npx github:im-Captain/dsh-session-rescue quarantine 37374e34    # 把坏会话移出 dsh 视野，防止拖垮启动
```

在用 AI agent？直接对它说：**"运行 `npx github:im-Captain/dsh-session-rescue`，把我损坏的 dsh 会话修好。"**
